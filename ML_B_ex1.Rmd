...
knitr::opts_chunk$set(tidy.opts=list(width.cutoff=60), tidy=TRUE, echo = TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=3)
```
...
fixed_Genres <- surveys_one_genre_fixed_date %>% separate(`Release Date`, c("day", "month", "year"), sep = " ", convert = TRUE)
