...
ggplot(data = surveys,  aes(y = `Hidden Gem Score`, x= `IMDb Score`)) +
  ...
  labs(title = "ITAMAR EXPLAINATION")
# We wanted to check the correlation between the movie's language and the movie's time length. From results we can see that its most likely to have 1.5 hours movie.
