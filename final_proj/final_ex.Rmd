...
knitr::opts_chunk$set(echo = TRUE, message=FALSE, warning=FALSE, fig.width=7, fig.height=2)
```
...
```
In the above table we see that all of the patients were predicted correctly. 
...
NOTE: the separation in LDA1 much better corresponding to the results above.
